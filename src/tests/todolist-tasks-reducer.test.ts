import {createTodoListActionCreator, TodolistDomainType, todolistsReducer_old} from "../old_trash/todolists-reducer_old";
import {tasksReducer_old, TasksStateType} from "../old_trash/tasks-reducer_old";
